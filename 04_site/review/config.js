 ...
 * 1. Create a subfolder: `04_site/review/[company-slug]/` (e.g. `04_site/review/hotel-bali/`)
 * 2. Copy `04_site/review/index.html` into `04_site/review/[company-slug]/index.html`
 * 3. Update the `PROSPECT_DATA` object inside the page or load this config.
 */
...
window.PROSPECT_DATA = {
    ...
    // Hero Copy
    headline: "Hallo Physiotherapie Muster,<br>wir haben eine persönliche Analyse Ihrer <span style=\"color: var(--brand--lemon, #fac118);\">Google-Präsenz</span> erstellt.",
